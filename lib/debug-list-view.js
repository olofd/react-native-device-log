...
import { Animated, FlatList, LayoutAnimation, NativeModules, PixelRatio, StyleSheet, Text, TouchableOpacity, View, } from 'react-native';
...
export default class Debug extends React.Component {
    constructor(props) {
        ...
        this._renderLogRow = (rowData, animationStyle) => {
        ...
        this._renderRow = ({ item, index, separators }) => {
            const rowData = item;
            let animationStyle = {};
            if (rowData.anim) {
                animationStyle = {
    ...
    _renderSeperator(rowData, animationStyle) {
        ...
        return (<Animated.View style={[styles.debugRowContainer, animationStyle]} onLayout={this.onRowLayout.bind(this, rowData)}>
    ...
    render() {
        ...
        <View style={styles.listContainer}>
          <FlatList ref={(flRef) => {
            this.flatlist = flRef;
        }} data={this.state.preparedRows} renderItem={this._renderRow} keyExtractor={(item) => item.id}/>
        </View>
      </View>);
    }
}
